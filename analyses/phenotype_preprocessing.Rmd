...
```{r anc_plot,
      echo=FALSE,
      fig.cap="Distribution of the Adjusted Neutrophil Count (ANC)."}
...
```{r loganc_plt,
      echo=FALSE,
      fig.cap="Distribution of the log transformation of the the Adjusted Neutrophil Count (ANC)."}
